...
public class TeamFoundationServerScm extends SCM {
    ...
    public TeamFoundationServerScm(String serverUrl, String projectPath, String localPath, boolean useUpdate, String workspaceName, String userName, String password) {
        this(serverUrl, projectPath, null, localPath, useUpdate, workspaceName, userName, Secret.fromString(password), null);
    }
    ...
    TeamFoundationServerScm(String serverUrl, String projectPath, String cloakedPaths, String localPath, boolean useUpdate, String workspaceName) {
        this(serverUrl, projectPath, cloakedPaths, localPath, useUpdate, workspaceName, null, (Secret)null, null);
    }

    @DataBoundConstructor
    public TeamFoundationServerScm(String serverUrl, String projectPath, String cloakedPaths, String localPath, boolean useUpdate, String workspaceName, String userName, Secret password, String mappedPaths) {
