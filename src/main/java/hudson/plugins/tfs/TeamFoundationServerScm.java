...
public class TeamFoundationServerScm extends SCM {
    ...
    public boolean checkout(AbstractBuild<?, ?> build, Launcher launcher, FilePath workspaceFilePath, BuildListener listener, File changelogFile) throws IOException, InterruptedException {
        ...
        try {
            ...
            CheckoutAction action = new CheckoutAction(workspaceConfiguration.getWorkspaceName(), workspaceConfiguration.getProjectPath(), workspaceConfiguration.getCloakedPaths(), workspaceConfiguration.getWorkfolder(), isUseUpdate(), showWorkspaces,  workspaceConfiguration.getMappedPaths());
            List<ChangeSet> list;
