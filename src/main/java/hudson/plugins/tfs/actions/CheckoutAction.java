...
public class CheckoutAction {
    ...
    public CheckoutAction(String workspaceName, String projectPath, Collection<String> cloakedPaths, String localFolder, boolean useUpdate, Collection<MappingItem> mappedPaths) {
    ...
    public List<ChangeSet> checkout(final Server server, final FilePath workspacePath, final VersionSpec lastBuildVersionSpec, final VersionSpec currentBuildVersionSpec) throws IOException, InterruptedException {
        ...
        if (lastBuildVersionSpec != null) {
            return project.getVCCHistoryWithoutCloaks(lastBuildVersionSpec, currentBuildVersionSpec, true, Integer.MAX_VALUE, mappedPaths);
        }
